...
This is a fork of the popular LiquidCrystal library for Arduino that supports my simple IO Abstraction framework - thus means that this same library code works for ardino pins, shift registers and i2c based IO. 
